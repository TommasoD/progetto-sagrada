...
class PrivateObjectiveTest {
    ...
    void checkBrightShade() {
        ...
        Die die8 = new Die("PURPLE");
        die8.setValue("1");
        window.windowMatrix[4][0].setDie(die8);

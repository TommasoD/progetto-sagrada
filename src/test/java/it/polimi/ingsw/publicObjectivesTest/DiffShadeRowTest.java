...
import it.polimi.ingsw.publicObjectivesTest.publicObjectives.DiffShadeRow;
...
class DiffShadeRowTest {
    ...
    void checkDiffShadeRow() {
        ...
        die2.setValue("2");
        window.getWindowMatrix(1, 0).setDie(die2);
        Die die3 = new Die("RED");
        die3.setValue("3");
        window.getWindowMatrix(2, 0).setDie(die3);
        Die die4 = new Die("RED");
        die4.setValue("4");
        window.getWindowMatrix(3, 0).setDie(die4);
        Die die5 = new Die("RED");
        die5.setValue("5");
        window.getWindowMatrix(4, 0).setDie(die5);
        Die die6 = new Die("RED");
        die6.setValue("6");
        window.getWindowMatrix(2, 1).setDie(die6);
        Die die7 = new Die("RED");
        die7.setValue("1");
        window.getWindowMatrix(4, 3).setDie(die7);
        Die die8 = new Die("RED");
        die8.setValue("1");
        window.getWindowMatrix(3, 3).setDie(die8);

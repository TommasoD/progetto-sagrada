...
public class Window19 extends WindowPattern {
    ...
    public Window19(){
        ...
        windowMatrix[3][0] = new Slot("RED", "none");
        ...
        windowMatrix[4][1] = new Slot("BLUE", "none");
        ...
        windowMatrix[4][2] = new Slot("none", "6");

        windowMatrix[0][3] = new Slot("YELLOW", "none");
        windowMatrix[1][3] = new Slot("none", "2");
        windowMatrix[2][3] = new Slot("GREEN", "none");
        windowMatrix[3][3] = new Slot("none", "1");
        windowMatrix[4][3] = new Slot("RED", "none");
    }

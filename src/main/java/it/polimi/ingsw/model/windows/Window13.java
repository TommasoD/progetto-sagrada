...
public class Window13 extends WindowPattern {
    ...
    public Window13(){
        ...
        windowMatrix[0][0] = new Slot("none", "3");
        ...
        windowMatrix[4][2] = new Slot("RED", "none");

        windowMatrix[0][3] = new Slot("none", "5");
        windowMatrix[1][3] = new Slot("none", "none");
        windowMatrix[2][3] = new Slot("YELLOW", "none");
        windowMatrix[3][3] = new Slot("RED", "none");
        windowMatrix[4][3] = new Slot("none", "6");
    }

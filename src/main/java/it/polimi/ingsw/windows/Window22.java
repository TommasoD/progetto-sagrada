...
public class Window22 extends WindowPattern {
    ...
    public Window22(){
        ...
        windowMatrix[0][2] = new Slot("none", "4");
        windowMatrix[1][2] = new Slot("RED", "none");
        windowMatrix[2][2] = new Slot("none", "2");
        windowMatrix[3][2] = new Slot("BLUE", "none");
        windowMatrix[4][2] = new Slot("none", "none");

        windowMatrix[0][3] = new Slot("GREEN", "none");
        windowMatrix[1][3] = new Slot("none", "6");
        windowMatrix[2][3] = new Slot("YELLOW", "none");
        windowMatrix[3][3] = new Slot("none", "3");
